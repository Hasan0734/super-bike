      ...
      <OwlCarousel className='owl-theme'
        ...
        <div className="item h-11/12 ">
          <div className="relative flex items-center">
            ...
            <div className="absolute md:left-64 sm:left-32 md:p-2 md:space-y-3 sm:space-y-1">
              ...
              <button className="rounded-md hover:bg-green-500 bg-green-400 md:p-2 sm:p-1 text-white sm:text-xs md:text-lg">Shop Now</button>
            </div>
          </div>
        </div>
        <div className="item h-11/12 ">
        ...
        <div className="item h-11/12 ">
          <div className="relative flex items-center justify-end left-0">
            <img className=" w-full" src={bannar4} alt="" />
            <div className="absolute md:left-3/4 md:p-2 right-16 text-white md:space-y-3 sm:space-y-1">
